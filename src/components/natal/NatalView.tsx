  ...
  if (error) {
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-4">
        <p className="text-base text-red-800 font-medium">계산 오류</p>
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-1 sm:gap-3">
            <h2 className="text-base font-medium text-gray-700">Natal Chart</h2>
            {!unknownTime && (
      ...
      {!unknownTime && chart.houses.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <h3 className="text-sm font-medium text-gray-500 mb-2">Houses</h3>
